        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-[#35271e]">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-xs text-[#c7b7aa] leading-relaxed font-light">
              {SPA_CONFIG.name} menghadirkan pengalaman spa eksklusif langsung ke tempat Anda. Nikmati ketenangan dan kesegaran raga kapan saja.
            </p>
          ...
          <div className="lg:col-span-3 space-y-3">
            <h4 className="text-xs font-serif font-semibold uppercase tracking-[0.2em] text-[#c49a6c]">MENU</h4>
            <ul className="grid grid-cols-2 gap-2 text-xs text-[#c7b7aa]">
              <li><a href="#hero" className="hover:text-white transition-colors">Home</a></li>
              <li><a href="#about" className="hover:text-white transition-colors">Tentang Kami</a></li>
              <li><a href="#services" className="hover:text-white transition-colors">Layanan & Harga</a></li>
              <li><a href="#features" className="hover:text-white transition-colors">Keunggulan</a></li>
              <li><a href="#flow" className="hover:text-white transition-colors">Cara Pesan</a></li>
          ...
          <div className="lg:col-span-3 space-y-3">
            <h4 className="text-xs font-serif font-semibold uppercase tracking-[0.2em] text-[#c49a6c]">HUBUNGI KAMI</h4>
            <div className="space-y-2.5 text-xs text-[#c7b7aa]">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <span>Jakarta, Tangerang, Bekasi</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-3">
            <h4 className="text-xs font-serif font-semibold uppercase tracking-[0.2em] text-[#c49a6c]">RESERVASI</h4>
